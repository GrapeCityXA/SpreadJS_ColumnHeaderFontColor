...
### SpreadJS 示例，自定义列头字体颜色
该示例包括使用 SpreadJS API 的演示脚本，可用于实现自定义列头字体颜色
...
```
HTML：
<div id='ss' style='width:1002px; height:400px;'></div>
...
JavaScript：
// Title：自定义列头字体颜色
// Description：自定义列头字体颜色
// Tag:列头，字体颜色

// Title：自定义列头字体颜色
// Description：自定义列头字体颜色
// Tag:列头，字体颜色
var oldgetThemeStyle = GC.Spread.Sheets.CellTypes.ColumnHeader.prototype.getThemeStyle;
GC.Spread.Sheets.CellTypes.ColumnHeader.prototype.getThemeStyle = function(visualState, defaultClass) {
    var style = oldgetThemeStyle.apply(this, [visualState, defaultClass]);
...
var sheet = spread.getActiveSheet();
sheet.getCell(0, 0, GC.Spread.Sheets.SheetArea.colHeader).foreColor("red");
sheet.getCell(0, 1, GC.Spread.Sheets.SheetArea.colHeader).foreColor("green");
```
